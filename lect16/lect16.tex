...
\lecture{16}{October 12}{Nicholas Harvey}{Kaitian Xie}
...
$\set{0, 1}^* = \set{\epsilon, 0, 1, 00, 01, \cdots}$ countable

$B = \set{0000\cdots, 111\cdots, 010101\cdots}$
...
There are many \textsf{TM}s

\begin{itemize}[label={$\Rightarrow$}]
  \item countably many decidable many languages (each decided by some \textsf{TM})
  \item countably many recognizable languages (each recognized by some \textsf{TM})
\end{itemize}
